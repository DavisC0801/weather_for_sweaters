...
describe "/api/v1/forecast" do
  ...
  it "includes city info" do
    VCR.use_cassette("forecasts/denver", allow_playback_repeats: true) do
      ...
      expect(parsed_response.keys).to contain_exactly(:city,
                                                      :state,
                                                      :country,
                                                      :date,
                                                      :time)
  ...
  it "includes current brief info" do
    VCR.use_cassette("forecasts/denver", allow_playback_repeats: true) do
      ...
      expect(parsed_response.keys).to contain_exactly(:current_brief_icon,
  ...
  it "includes current detailed info" do
    VCR.use_cassette("forecasts/denver", allow_playback_repeats: true) do
      ...
      expect(parsed_response.keys).to contain_exactly(:current_detail_icon,
  ...
  it "includes hourly info" do
    VCR.use_cassette("forecasts/denver", allow_playback_repeats: true) do
      ...
      expect(parsed_response.first.keys).to contain_exactly(:hourly_time,
                                                            :hourly_icon,
                                                            :hourly_temp)
  ...
  it "includes daily info" do
    VCR.use_cassette("forecasts/denver", allow_playback_repeats: true) do
      ...
      expect(parsed_response.first.keys).to contain_exactly(:daily_name,
                                                            :daily_icon,
                                                            :daily_summary,
                                                            :daily_percipitation_chance,
                                                            :daily_high,
                                                            :daily_low)
